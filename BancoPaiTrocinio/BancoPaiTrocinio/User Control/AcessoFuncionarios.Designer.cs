...
namespace BancoPaiTrocinio.User_Control {
    partial class AcessoFuncionarios {
        /// <summary> 
        ...
        private void InitializeComponent() {
            ...
            this.dados_func.Controls.Add(this.Txt_Logradouro);
            this.dados_func.Controls.Add(this.lbl_logradouro);
            this.dados_func.Controls.Add(this.lbl_nome);
            this.dados_func.Controls.Add(this.Txt_Nome);
            this.dados_func.Controls.Add(this.Lbl_Celular);
            this.dados_func.Controls.Add(this.Txt_CPF);
            this.dados_func.Controls.Add(this.Txt_Celular);
            this.dados_func.Controls.Add(this.Lbl_CPF);
            this.dados_func.Controls.Add(this.Lbl_Email);
            this.dados_func.Controls.Add(this.Txt_Rg);
            this.dados_func.Controls.Add(this.Txt_Email);
            this.dados_func.Controls.Add(this.Txt_Telefone);
            this.dados_func.Controls.Add(this.Lbl_Telefone);
            ...
            this.Controls.Add(this.dados_func);
